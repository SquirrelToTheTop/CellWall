 ...
 * 
 */
class CellWallMonolayer : public CellWallObject{
  ...
  public:
    ...
    int get_number_of_mesh_elements(); // return the number of mesh elements
  ...
  private:
    ...
    int _nmesh_elements = 0; // number of mesh element
